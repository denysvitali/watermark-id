...
const en = {
  ...
  stepAddTitle: 'Add photos',
  stepAddBody: 'Drop an ID photo, or several, from this device.',
  stepMarkTitle: 'Mark locally',
  stepMarkBody: 'Crop and watermark stay in the browser. Nothing is uploaded.',
  stepExportTitle: 'Export',
  stepExportBody: 'Download a JPEG, PNG, WebP, or a ZIP of the whole batch.',
  openSourceTitle: 'Open source',
  openSourceBody: 'Audit the code, file an issue, or send a pull request.',
