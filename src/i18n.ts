...
const en = {
  pageTitle: 'Watermark ID — Private watermarks in your browser',
  metaDescription: 'Crop and watermark ID photos in your browser. Nothing is uploaded.',
  language: 'Language',
  ...
  heroLead: 'Watermark your ID.',
  heroAccent: 'Nothing leaves this device.',
  heroDescription: 'Crop and mark ID photos in this browser. Open source. No uploads.',
  ...
  dragToReposition: 'Drag or pinch to crop',
